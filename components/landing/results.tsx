...
const results = [
  { icon: Clock, title: "Меньше операционной нагрузки", description: "Повторяющиеся действия выполняются по заданной логике." },
  { icon: Shield, title: "Меньше ошибок", description: "Проверки и шаблоны работают одинаково каждый раз." },
  { icon: Zap, title: "Быстрее отчёты", description: "Данные собираются и приводятся к виду без лишних действий." },
  { icon: Eye, title: "Прозрачнее процессы", description: "Руководитель видит результат, сотрудники — понятный инструмент." },
  { icon: Users, title: "Удобнее сотрудникам", description: "Инструмент встраивается в процесс без лишней сложности." },
  { icon: TrendingUp, title: "Можно масштабировать", description: "Начать с одного файла, затем расширять автоматизацию." },
]
