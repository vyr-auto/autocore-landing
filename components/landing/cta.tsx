      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="premium-card relative overflow-hidden rounded-2xl p-6 sm:p-8 lg:p-10">
            <div className="cta-glow-blur pointer-events-none absolute right-0 top-0 h-72 w-72 translate-x-1/2 -translate-y-1/2 rounded-full bg-[#d4af371c] blur-xl" />
            <div className="cta-glow-blur pointer-events-none absolute bottom-0 left-0 h-64 w-64 -translate-x-1/2 translate-y-1/2 rounded-full bg-[#b8922e1c] blur-xl" />
